<template>
    <div class="table-box">
        ...
        <el-dialog :modal="false" draggable v-model="dialogVisible" title="请选择下单金额" width="20%">
            <el-select v-model="price" placeholder="请选择金额" style="width: 100%">
...
import { BuyProduct, getMerchantInfo, getProductList } from "@/api/modules/merchant";
